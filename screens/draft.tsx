...
const [otherCards, setOtherCards] = useState([]);
  ...
  const handleNextCard = () => {
    // If there's only one card or less, don't do anything
    if (profiles.length + SavedCards.length <= 1) {
      return;
    }
    
    if (!isAnimating) {
      setIsAnimating(true);
      const maxVisibleCards = Math.min(4, profiles.length + SavedCards.length);
          ...
          // Original layout for the first card
                  ...
                  <>
                    {SavedCards.length > 0 ? (
                      ...
                      /* Show Invite Contact button Profile Card */
                                                          <View style={styles.inviteCardContainer}>
                                                            ...
                                                            >
                                                              <View style={styles.inviteCardHeader}>
                                                                <MaterialIcons name="group-add" size={48} color="white" />
                            ...
                            Download now and let's connect! 🚀`,
                                                                ...
                                                                >
                                                                  ...
                                                                  >
                                                                    <MaterialIcons name="share" size={20} color="#8e44ad" />
                                                                    <Text style={styles.inviteContactsButtonText}>Invite Contacts</Text>
                                                                  </LinearGradient>
                                                                </TouchableOpacity>
                                                              </View>
                            
                                                              <View style={styles.inviteCardStats}>
                                                                <View style={styles.inviteStatItem}>
                                                                  <Text style={styles.inviteStatNumber}>1M+</Text>
                                                                  <Text style={styles.inviteStatLabel}>Users</Text>
                                                                </View>
                                                                <View style={styles.inviteStatDivider} />
                                                                <View style={styles.inviteStatItem}>
                                                                  <Text style={styles.inviteStatNumber}>50M+</Text>
                                                                  <Text style={styles.inviteStatLabel}>Connections</Text>
                                                                </View>
                                                                <View style={styles.inviteStatDivider} />
                                                                <View style={styles.inviteStatItem}>
                                                                  <Text style={styles.inviteStatNumber}>4.9★</Text>
                                                                  <Text style={styles.inviteStatLabel}>Rating</Text>
                                                                </View>
                                                              </View>
                                                            </LinearGradient>
                                                          </View>
