...
// Array of saved cards from Firebase
const [SavedCards, setSavedCards] = useState<Profile[]>([]);
  ...
  const [showMoreCards, setShowMoreCards] = useState(false);  const [otherCards, setOtherCards] = useState([]);
  ...
  const handleNextCard = () => {
    if (!isAnimating) {
      setIsAnimating(true);
      const totalCards = profiles.length + SavedCards.length;
  ...
  <View style={styles.searchPreview}>
    ...
    <View style={styles.inviteContainer}>
      ...
      <View style={styles.profileCardContainer}>
        ...
        ) : ( [...profiles, ...SavedCards].map((profile, index) => {
